...
<img
  src="/static/images/ai_log_pcapng/parsed_dataframe.png"
  alt="日志解析后 DataFrame head()"
  width="700"
/>
...
<img src="/static/images/ai_log_pcapng/tcp_syn_statistics.png" alt="TCP SYN 行为统计" width="700" />
